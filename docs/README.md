...
| [`natural-language-rca-and-code-evidence-spec.md`](natural-language-rca-and-code-evidence-spec.md) | 自然语言、Trace、运行时锚点、部署版本、代码证据与联合 RCA 的完整演进规格；当前前五阶段已落地 | 每项能力实现前保持合同先行，不能把未实现项写成当前能力 |
